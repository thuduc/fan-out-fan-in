...
class TaskInvoker:
    """Lightweight adapter around an AWS Lambda client.

    The invoker mirrors the behaviour of the Node.js LambdaInvoker used by the
    main orchestrator, keeping the interface minimal so tests can swap in a
    fake or stub implementation.
    """
