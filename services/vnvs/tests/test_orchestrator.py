...
def _load_task_processor_cls():
    ...
    base_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', 'vnas', 'app'))
    # Add vnas app directory to sys.path so constants module can be found
...
class RequestOrchestratorIntegrationTests(unittest.TestCase):
    ...
    def test_full_happy_path(self):
        ...
        # Response is the processed request XML (not wrapped in <response>)
        self.assertIsNotNone(stored_response)
        self.assertIn("<req", stored_response)
